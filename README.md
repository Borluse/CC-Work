...
轻量需求文档维护插件：agent 干活时同步维护需求/设计/Review 文档，设计阶段按设计树待处理前沿轮次提问对齐细节、确认共识后落盘，以设计文档为沟通媒介，支持基于文档总结工作。

**Skills：**

| Skill | 说明 |
|-------|------|
| `story-lite` | 轻量需求工作流 — 需求整理/设计（前沿轮次提问后落盘，含需求拆分）/实现（文档同步）/Review（文档输出）/整合与总结 |
